...
def evaluation(folder_data, folder_checkpoint):
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            dropout_keep_prob_cnn = graph.get_operation_by_name("dropout_keep_prob_cnn").outputs[0]
            dropout_keep_prob_rnn = graph.get_operation_by_name("dropout_keep_prob_rnn").outputs[0]
