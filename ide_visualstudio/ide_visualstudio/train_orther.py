...
from text_merge_nn_seq import Text_NN
...
def training_data(folder_data, timestamp, flg_model, dev_sample_percentage,
                  ...
                  dropout_keep_prob, l2_reg_lambda, max_pool_size,
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            model = None
            if flg_model == 'CNN':
                print('Training data with model neural is CNN')
                ...
                print('Training data with model neural is GRNN')
                ...
                print('Training data with model neural is CNN + GRNN, maxpool -> input RNN')
...
if __name__ == "__main__":
    ...
    # folder_test = 'train'
    # file_log = 'log_accurancy_model'
    # arg_value = 'NN'
    # run_tran(folder_test, file_log, arg_value)
    # print("----------------------------")
